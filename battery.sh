#!/bin/bash
# ============================================
# Battery Alert for Windows - Setup Script
# Run this inside your project folder in Termux
# ============================================

set -e

echo "🔋 Creating Battery Alert for Windows..."
echo ""
...
# ==============================
cat > src/battery_alert.ps1 << 'PWSHEOF'
# ============================================
...
echo "📝 Created src/battery_alert.ps1"

# ==============================
# Batch launcher (for easy double-click)
# ==============================
cat > start.bat << 'BATCHEOF'
@echo off
title Battery Alert 🔋
...
# Config file
# ==============================
cat > config.ini << 'CFGEOF'
[settings]
# Battery low threshold percentage
low_threshold = 20

# Battery full threshold percentage
full_threshold = 95
...
- ⚠️ **Low battery alert** — notifies you when battery drops below threshold
- ✅ **Full battery alert** — notifies you when battery is fully charged
- 🔔 Windows toast notifications + beep sounds
