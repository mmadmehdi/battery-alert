...
git add -A
git commit -m "نسخه 1.6 - تغییر کامل منطق دریافت باتری: لحظه‌ای و رویدادمحور به‌جای پرسیدن دوره‌ای"
...
echo "=================================="
echo ""
echo "تغییر اصلی این نسخه: برنامه دیگر هر چند دقیقه یک‌بار نمی‌پرسد باتری چقدر است."
echo "به‌جایش مستقیم به پخش سیستمی تغییرات باتری گوش می‌دهد (ACTION_BATTERY_CHANGED)"
echo "که خود اندروید همان لحظه‌ی تغییر درصد یا وصل/قطع شارژر می‌فرستد."
echo "یعنی دیگر هیچ تاخیری در دریافت درصد باتری نباید وجود داشته باشد."
echo ""
echo "آلارم پشتیبان (هر ۱۵ دقیقه) هم به‌عنوان بیمه باقی مانده، برای وقتی که"
echo "سیستم خودِ سرویس را کشته باشد."
echo ""
